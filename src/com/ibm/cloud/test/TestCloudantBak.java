...
public class TestCloudantBak {
	...
	public void main() {
		...
		//getDocumentInDatabase(databaseName,"PARTY_10000");
		
		//searchDocumentInDatabase(databaseName,"party01/partySearch","_id:PARTY*");
		//searchDocumentInDatabase(databaseName,"party01/partySearch","SAPPARTYNUM:9702*");
		//searchDocumentInDatabase(databaseName,"party01/partySearch","TABLE:PAR*");
		
		//createDocumentInDatabase(databaseName,DocumentDetails.partyDocumentFields,DocumentDetails.partyDocumentFieldsValue_10000);
		//getDocumentInDatabase(databaseName,"PARTY_30000");
		
		//updateDocumentInDatabase(databaseName, "PARTY_40000", "NAME3", "Name3");
		//getDocumentInDatabase(databaseName,"PARTY_30000");
		
		//deleteDocumentInDatabase(databaseName, "PARTY_40000");
		//getDocumentInDatabase(databaseName,"PARTY_40000");
